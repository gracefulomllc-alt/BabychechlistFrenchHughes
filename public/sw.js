...
const C="baby-prep-v13";
self.addEventListener("install",e=>{e.waitUntil(caches.open(C).then(c=>c.addAll(["/","/party.js","/ram.svg","/weeks.js","/after.js","/prices.js","/manifest.json","/icon-192.png"])));self.skipWaiting();});
